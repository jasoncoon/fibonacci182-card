...
void xPalette() {
  for (uint16_t i = 0; i < NUM_LEDS; i++) {
    leds[i] = ColorFromPalette(currentPalette, beat8(30) - coordsX[i]);
  }
}

void yPalette() {
  for (uint16_t i = 0; i < NUM_LEDS; i++) {
    leds[i] = ColorFromPalette(currentPalette, beat8(30) - coordsY[i]);
  }
}

void xyPalette() {
  for (uint16_t i = 0; i < NUM_LEDS; i++) {
    leds[i] = ColorFromPalette(currentPalette, beat8(30) - coordsX[i] - coordsY[i]);
  }
}

void radiusPalette() {
  for (uint16_t i = 0; i < NUM_LEDS; i++) {
    leds[i] = ColorFromPalette(currentPalette, beat8(30) - radius[i]);
  }
}

void anglePalette() {
  for (uint16_t i = 0; i < NUM_LEDS; i++) {
    leds[i] = ColorFromPalette(currentPalette, beat8(30) - angles[i]);
  }
}
